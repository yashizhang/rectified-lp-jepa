...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  ...
  --config-name=rectified_lpjepa_imagenet_mila.yaml \
...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  --config-path=scripts/pretrain/imagenet-100/ \
  --config-name=sigjepa_imagenet100_mila.yaml \
  ++wandb.entity=yashi-zhang \
  ++wandb.project=jepa \
  ++wandb.enabled=true
...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  --config-path=scripts/pretrain/imagenet-100/ \
  --config-name=teacher_jepa_full_imagenet100_mila.yaml \
  ++wandb.entity=yashi-zhang \
  ++wandb.project=jepa \
  ++wandb.enabled=true
...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  --config-path=scripts/pretrain/imagenet-100/ \
  --config-name=teacher_sigjepa_full_imagenet100_mila.yaml \
  ++wandb.entity=yashi-zhang \
  ++wandb.project=jepa \
  ++wandb.enabled=true
...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  --config-path=scripts/pretrain/imagenet-100/ \
  --config-name=split_teacher_sigjepa_imagenet100_mila.yaml \
  ++wandb.entity=yashi-zhang \
  ++wandb.project=jepa \
  ++wandb.enabled=true
...
CUDA_VISIBLE_DEVICES=0,1,2 python3 main_pretrain.py \
  --config-path=scripts/pretrain/imagenet-100/ \
  --config-name=split_teacher_sigjepa_b6_imagenet100_mila.yaml \
  ++wandb.entity=yashi-zhang \
  ++wandb.project=jepa \
  ++wandb.enabled=true
...
#   split_teacher_sigjepa_split_c256_f1792_imagenet100_mila.yaml
#   split_teacher_sigjepa_split_c1792_f256_imagenet100_mila.yaml
# Teacher-weight sweep configs available:
#   split_teacher_sigjepa_lambda_teacher_0p5_imagenet100_mila.yaml
#   split_teacher_sigjepa_lambda_teacher_2p0_imagenet100_mila.yaml
# SIGReg-weight sweep configs available:
#   split_teacher_sigjepa_lambda_sigreg_0p01_imagenet100_mila.yaml
#   split_teacher_sigjepa_lambda_sigreg_0p1_imagenet100_mila.yaml
# SIGReg-slice sweep configs available:
#   split_teacher_sigjepa_num_slices_64_imagenet100_mila.yaml
#   split_teacher_sigjepa_num_slices_1024_imagenet100_mila.yaml
